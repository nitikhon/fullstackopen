...
describe('total likes', () => {
    ...
    test('when list has only one element, total likes equals to that element', () => {
...
describe('most likes', () => {
    ...
    test('when list has only one blog, most liked equals to that blog', () => {
...
describe('most blogs', () => {
    ...
    test('when list has only one blog, most blogs equals to that blog', () => {
